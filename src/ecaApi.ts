...
export const chatPromptSteerRemove = new rpc.NotificationType<p.ChatPromptStopParams>('chat/promptSteerRemove');
...
export const chatList = new rpc.RequestType<p.ChatListParams, p.ChatListResponse, void>('chat/list');
export const chatOpen = new rpc.RequestType<p.ChatOpenParams, p.ChatOpenResponse, void>('chat/open');
...
export const editorGetDefinition = new rpc.RequestType<p.EditorGetDefinitionParams, p.EditorGetDefinitionResult, void>('editor/getDefinition');
export const editorGetReferences = new rpc.RequestType<p.EditorGetReferencesParams, p.EditorGetReferencesResult, void>('editor/getReferences');
